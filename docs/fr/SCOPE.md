...
Le scope est toujours obligatoire comme garde-fou, mais le fichier `scope.txt`
ne l'est pas. ScanForge résout un périmètre effectif avant de créer un run,
puis filtre les artefacts transmis entre modules.
